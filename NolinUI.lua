...
function NolinUI:CreateWindow(config)
    ...
    function Window:CreateTab(tabCfg)
        ...
        -- ============================================================================
        -- CREATE SLIDER (Rayfield-style, гарантированно рабочий)
        -- ============================================================================
        ...
        function Tab:CreateSlider(sCfg)
            ...
            -- Track (базовый Frame, БЕЗ TextButton)
            local track = new("Frame", {
            ...
            -- Кнопка-хитбокс поверх трека (широкая для удобства)
                ...
                ob.MouseButton1Click:Connect(function()
                    if multi then
                        ...
                        for _, b in ipairs(oBtns) do
                            local bn = string.gsub(b.Name, "Op_", "")
                            if bn == txt then
